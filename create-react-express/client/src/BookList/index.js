...
function previewBook(bookURL) { 
  console.log('Preview button clicked. Book URL: ' + JSON.stringify(bookURL, '', 2)); 
    ...
    <div className="row" key={index}>
      ...
      <div className="row" id="buttonRow">
        <div className="col">
          ...
          (
          <div className="row">
            <div className="col"><Button onClick={()=> props.onBookSave(book, index)} type="success" className="input-lg"><span>Save Book</span></Button></div>
            <div className="col" id="msgText">{book.saved ? "Book Saved" : ''}</div>
          </div>
          )
          :
          (<Button
